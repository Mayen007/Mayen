...
// Use the public client for REST requests so an invalid token does not break public API calls.
export const octokit = unauthenticatedOctokit;
...
/**
 * Run a REST request against the public client.
 */
